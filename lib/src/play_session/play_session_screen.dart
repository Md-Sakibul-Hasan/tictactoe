                  ...
                  return _ResponsivePlaySessionScreen(
                    ...
                    backButtonArea: DelayedAppear(
                      ...
                      child: InkResponse(
                        ...
                        child: Tooltip(
                          message: 'Back',
                          child: Image.asset('assets/games/tic_tac_toe/images/back.png'),
                        ),
                      ),
                    ),
                    settingsButtonArea: DelayedAppear(
                      ...
                      child: InkResponse(
                        ...
                        child: Tooltip(
                          message: 'Settings',
                          child: Image.asset('assets/games/tic_tac_toe/images/settings.png'),
                        ),
                      ),
                    ),
                  );
        ...
        child: Column(
          children: [
            ScaleTransition(
              ...
              child: Image.asset('assets/games/tic_tac_toe/images/restart.png'),
            ),
            const Text(
              'Restart',
              style: TextStyle(

...
class _SketchedX extends StatelessWidget {
  ...
  static const _startImageAssets = [
    'assets/games/tic_tac_toe/images/cross-start-1.png',
    'assets/games/tic_tac_toe/images/cross-start-2.png',
    'assets/games/tic_tac_toe/images/cross-start-3.png',
    'assets/games/tic_tac_toe/images/cross-start-4.png',
    'assets/games/tic_tac_toe/images/cross-start-5.png',
  ];

  static const _endImageAssets = [
    'assets/games/tic_tac_toe/images/cross-end-1.png',
    'assets/games/tic_tac_toe/images/cross-end-2.png',
    'assets/games/tic_tac_toe/images/cross-end-3.png',
    'assets/games/tic_tac_toe/images/cross-end-4.png',
    'assets/games/tic_tac_toe/images/cross-end-5.png',
  ];
...
class _SketchedO extends StatelessWidget {
  ...
  static const _imageAssets = [
    'assets/games/tic_tac_toe/images/circle1.png',
    'assets/games/tic_tac_toe/images/circle2.png',
    'assets/games/tic_tac_toe/images/circle3.png',
    'assets/games/tic_tac_toe/images/circle4.png',
    'assets/games/tic_tac_toe/images/circle5.png',
  ];
